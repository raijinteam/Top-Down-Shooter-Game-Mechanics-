...
public class CobraData : EnemyHandler
{
    ...
    public void SetData() {
        ...
        cobraTrigger.enabled = true;
        cobraMovement.enabled = true;
        body.enabled = true;
