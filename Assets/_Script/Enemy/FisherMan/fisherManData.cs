...
public class fisherManData : EnemyHandler
{
    ...
    [SerializeField] private FishermanMotion fisherManMotion;
    [SerializeField] private fisherManTrigger fishemanTrigger;
   
    
    [SerializeField] private Collider body;
    [SerializeField] private MMF_Player spawn_MMFPlayer;

    private fisherManData current;

    [Header("Chain Vfx")]
    [SerializeField] private GameObject obj_ChainVfx;

    [Header("Spawner")]
    [SerializeField] private fisherManData fisherMan;
    ...
    public override void SpawnEnemy() {
        ...
        while (!isSpawn) {
            ...
            if (!Physics.Raycast(postion, Vector3.down, 1000, obstckle_Layer)) {
                ...
                current = Instantiate(fisherMan, postion, transform.rotation);
    ...
    public void SetData() {
        ...
        fisherManMotion.enabled = true;
        fishemanTrigger.enabled = true;
        body.enabled = true;
