...
public class BeeData : EnemyHandler
{
    [Header("All Script Campaotant")]
    [SerializeField] private BeeData bat;
    [SerializeField] private EnemyHealth enemyHealth;
    [SerializeField] private BeeMotion beemotion;
    ...
    public override void SpawnEnemy() {
        ...
        while (!isSpawn) {
            ...
            if (!Physics.Raycast(postion, Vector3.down, 1000, obstckle_Layer)) {
                ...
                seq.AppendInterval(1).Append(current_Bat.transform.DOMoveY(flt_YTopPostion, 0.5f))
                    .Append(current_Bat.transform.DOMoveY(flt_DownPostion, 0.5f)).
