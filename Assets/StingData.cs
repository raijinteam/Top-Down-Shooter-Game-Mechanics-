...
public class StingData : EnemyHandler
{
    ...
    [SerializeField] private stingData sting;
    [SerializeField] private EnemyHealth enemyHealth;
    [SerializeField] private stingMotion stingMotion;
    ...
    private stingData current_Sting;
        ...
        while (!isSpawn) {
            ...
            if (!Physics.Raycast(postion, Vector3.down, 1000, obstckle_Layer)) {
                ...
                seq.AppendInterval(1).Append(current_Sting.transform.DOMoveY(flt_DownPostion, 0.5f))
                    .Append(current_Sting.transform.DOMoveY(3, 0.5f)).
                    AppendCallback(DestroyIndicator);
                isSpawn = true;
            }
        }
    }
