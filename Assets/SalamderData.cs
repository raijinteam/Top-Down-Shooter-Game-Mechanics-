...
public class SalamderData : EnemyHandler {
    ...
    [SerializeField] private SalamaderTrigger salamanderTrigger;
    [SerializeField] private SalaManderMotion salamanderMovement;
    [SerializeField] private Collider body;
    [SerializeField] private MMF_Player spawn_MMFPlayer;

    private SalamderData current;

    [Header("Chain Vfx")]
    [SerializeField] private GameObject obj_ChainVfx;

    [Header("Spawner")]
    [SerializeField] private SalamderData salamander;
    ...
    public override void SpawnEnemy() {
        ...
        while (!isSpawn) {
            ...
            if (!Physics.Raycast(postion, Vector3.down, 1000, obstckle_Layer)) {
                ...
                current = Instantiate(salamander, postion, transform.rotation);
    ...
    public void SetData() {
        ...
        salamanderTrigger.enabled = true;
        salamanderMovement.enabled = true;
        body.enabled = true;
